...
class DashboardTests(TestCase):
    ...
    def test_weather_zip_code_is_consistent(self):
        context1 = get_weather_context('22181')
        context2 = get_weather_context('22181')
        self.assertEqual(context1, context2)
        self.assertEqual(context1['city_weather']['city'], 'Vienna')
